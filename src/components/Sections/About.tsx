...
const About = () => {
    return (
        <section id='sobre' className='pt-24 scroll-m-16'>
            <Grid>
            ...
            <Grid className='items-center mt-8 gap-y-16'>
                <div className='col-start-2 col-span-10 lg:col-span-6 xl:col-span-5 xl:col-start-2'>
                    <Text>
                ...
                <div className='col-span-10 col-start-2 lg:col-span-6 xl:col-span-4 xl:col-start-8 relative rounded-md overflow-hidden shadow-[6px_6px_0_#995759]'>
