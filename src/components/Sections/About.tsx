            ...
            <Grid className='items-center mt-8 gap-y-16'>
                <div className='col-span-12 md:col-start-2 md:col-span-10 lg:col-span-6 xl:col-span-5 xl:col-start-2'>
                    <Text>
                        ...
                        <br />
                        <br />
                        Mas algo surpreendente aconteceu este ano: o destino levou-me a descobrir uma nova paixão: o marketing digital.💡Tirei o curso de Gestão
                        de Redes Sociais e dei vida ao meu próprio negócio.📱
                        <br />
                        <br />
